    ...
    <form @submit.prevent="generateReport" class="space-y-6">
      ...
      <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50" :class="{ 'border-primary-500 bg-primary-50': reportForm.type === 'summary' }">
            <input v-model="reportForm.type" type="radio" value="summary" class="sr-only" />
            <div class="flex items-center">
              <div class="w-4 h-4 border-2 rounded-full mr-3" :class="{ 'border-primary-500 bg-primary-500': reportForm.type === 'summary', 'border-gray-300': reportForm.type !== 'summary' }">
          ...
          <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50" :class="{ 'border-primary-500 bg-primary-50': reportForm.type === 'detailed' }">
            <input v-model="reportForm.type" type="radio" value="detailed" class="sr-only" />
            <div class="flex items-center">
              <div class="w-4 h-4 border-2 rounded-full mr-3" :class="{ 'border-primary-500 bg-primary-500': reportForm.type === 'detailed', 'border-gray-300': reportForm.type !== 'detailed' }">
          ...
          <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50" :class="{ 'border-primary-500 bg-primary-50': reportForm.type === 'category' }">
            <input v-model="reportForm.type" type="radio" value="category" class="sr-only" />
            <div class="flex items-center">
              <div class="w-4 h-4 border-2 rounded-full mr-3" :class="{ 'border-primary-500 bg-primary-500': reportForm.type === 'category', 'border-gray-300': reportForm.type !== 'category' }">
